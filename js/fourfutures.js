function getFuture() {
  ...
  var bizmodels = [
    ...
    'an artificial intelligence powered by crowdsourcing that facilitates participatory budgeting',
    'an artificial intelligence powered by crowdsourcing that facilitates democratic processes',   
    ...
    'a gig economy platform powered by artificial intelligence',
    'a decentralized, self-organized, globally distributed community that collectively buys and redistributes land',
  ...
  var xfactors = [
    'for researchers, activists, and citizens',
    ...
    'for cloud production or distributed manufacturing',
    ...
    'for bioethics communities',
    'for going off the grid',
    'for digital humanitarians',
    'for disaster response',
    'for transitioning to a Commons-based society',
    'for the equitable distribution of wealth, land, and power'
    ];
