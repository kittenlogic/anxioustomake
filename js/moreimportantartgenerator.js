...
function updateArtProjectGenerator(){
    ...
    var mediumPopup, adjectivePopup, adjectivePopup2, adverbPopup, gerundPopup;
    ...
    if (r == 0){
      $(".newproject").append("<span>Commission " + articleM + " " + medium + mediumPopup + " about " + newTopic + ", made " + adverb + adverbPopup + "</span>");
    }
    else if (r == 1){
      $(".newproject").append("<span>Commission " + articleM + " " + medium + mediumPopup + " about " + newTopic + "</span>");
    }
    else if (r == 2){
      $(".newproject").append("<span>Commission " + articleM + " " + medium + mediumPopup + " about " + newTopic + ", generated by " + gerund + gerundPopup + "</span>");
    }
    else if (r == 3){ 
      $(".newproject").append("<span>Commission " + articleM + " " + medium + mediumPopup +"  about " + newTopic + ", generated by " + gerund + " " + adverb + adverbPopup + "</span>");
    }
    else if (r == 4){
      $(".newproject").append("<span>Commission " + articleA + " " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + newTopic + "</span>");
    }
    else if (r == 5){
      $(".newproject").append("<span>Commission " + articleA + " "  + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + newTopic + ", made " + adverb + adverbPopup + "</span>");
    }
    else if (r == 6){
      $(".newproject").append("<span>Commission " + articleA + " "  + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + newTopic + ", generated by " + gerund + gerundPopup + "</span>");
    }
    else if (r == 7){
      $(".newproject").append("<span>Commission " + articleA + " "  + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + newTopic + ", generated by " + gerund + gerundPopup + " " + adverb + adverbPopup + "</span>");
    }
    else if (r == 8){
      $(".newproject").append("<span>Commission " + articleA + " "  + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + adjective2 + adjectivePopup2 + " " + newTopic + "</span>");
    }
    else if (r == 9){
      $(".newproject").append("<span>Commission " + articleA + " "  + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + adjective2 + adjectivePopup2 + " " + newTopic + ", made " + adverb + adverbPopup + "</span>");
    }
    else if (r == 10){
      $(".newproject").append("<span>Commission " + articleA + " "  + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + newTopic + ", generated by " + gerund + gerundPopup + "</span>");
    }
...
$('#importantThings input').on('change', function() {
   newTopic = $('input[name="important"]:checked', '#importantThings').val(); 
   $('#anythingyouwant input').val('');
});
$('#anythingyouwant input').on('blur', function() {
   newTopic = $('input[type="text"]', '#anythingyouwant').val();
