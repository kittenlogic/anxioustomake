...
function updateArtProjectGenerator(){
    ...
    if (r == 0){
      $(".newproject").append("<span>Commission a " + medium + mediumPopup + " about " + newTopic + ", made " + adverb + adverbPopup + "</span>");
    }
    else if (r == 1){
      $(".newproject").append("<span>Commission a " + medium + mediumPopup + " about " + newTopic + "</span>");
    }
    else if (r == 2){
      $(".newproject").append("<span>Commission a " + medium + mediumPopup + " about " + newTopic + ", generated by " + gerund + gerundPopup + "</span>");
    }
    else if (r == 3){ 
      $(".newproject").append("<span>Commission a " + medium + mediumPopup +"  about " + newTopic + ", generated by " + gerund + " " + adverb + adverbPopup + "</span>");
    }
    else if (r == 4){
      $(".newproject").append("<span>Commission " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + newTopic + "</span>");
    }
    else if (r == 5){
      $(".newproject").append("<span>Commission " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + newTopic + ", made " + adverb + adverbPopup + "</span>");
    }
    else if (r == 6){
      $(".newproject").append("<span>Commission " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + newTopic + ", generated by " + gerund + gerundPopup + "</span>");
    }
    else if (r == 7){
      $(".newproject").append("<span>Commission " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + newTopic + ", generated by " + gerund + gerundPopup + " " + adverb + adverbPopup + "</span>");
    }
    else if (r == 8){
      $(".newproject").append("<span>Commission " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + adjective2 + adjectivePopup2 + " " + newTopic + "</span>");
    }
    else if (r == 9){
      $(".newproject").append("<span>Commission " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + adjective2 + adjectivePopup2 + " " + newTopic + ", made " + adverb + adverbPopup + "</span>");
    }
    else if (r == 10){
      $(".newproject").append("<span>Commission " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + newTopic + ", generated by " + gerund + gerundPopup + "</span>");
    }
