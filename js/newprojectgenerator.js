...
function articleMedium(){
  if (medium.substr(0,1).match(/[aeiou]/i)) {
      articleM = "an";
  } else {
      articleM = "a";
  }
  console.log("articleM: " + articleM);
}

function articleAdjective(){
  if (adjective.substr(0,1).match(/[aeiou]/i) ) {
      articleA = "an";
  } else {
      articleA = "a";
  }
...
function updateArtProjectGenerator(){
    ...
    if (r == 0){
      $(".newproject").append("<span>Commission " + articleM + " " + medium + mediumPopup + " about " + topic + topicPopup + ", made " + adverb + adverbPopup + "</span>");
    }
    else if (r == 1){
      $(".newproject").append("<span>Commission " + articleM + " " + medium + mediumPopup + " about " + topic + topicPopup + "</span>");
    }
    else if (r == 2){
      $(".newproject").append("<span>Commission " + articleM + " " + medium + mediumPopup + " about " + topic + topicPopup + ", generated by " + gerund + gerundPopup + "</span>");
    }
    else if (r == 3){ 
      $(".newproject").append("<span>Commission " + articleM + " " + medium + mediumPopup +"  about " + topic + topicPopup + ", generated by " + gerund + " " + adverb + adverbPopup + "</span>");
    }
    else if (r == 4){
      $(".newproject").append("<span>Commission " + articleA + " " + adjective + adjectivePopup + " " + medium + mediumPopup + "</span>");
    }
    else if (r == 5){
      $(".newproject").append("<span>Commission " + articleA + " " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + topic + topicPopup + "</span>");
    }
    else if (r == 6){
      $(".newproject").append("<span>Commission " + articleA + " " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + topic + topicPopup + ", made " + adverb + adverbPopup + "</span>");
    }
    else if (r == 7){
      $(".newproject").append("<span>Commission " + articleA + " " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + topic + topicPopup + ", generated by " + gerund + gerundPopup + "</span>");
    }
    else if (r == 8){
      $(".newproject").append("<span>Commission " + articleA + " " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + topic + topicPopup + ", generated by " + gerund + gerundPopup + " " + adverb + adverbPopup + "</span>");
    }
    else if (r == 9){
      $(".newproject").append("<span>Commission " + articleA + " " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + adjective2 + adjectivePopup2 + " " + topic2 + topicPopup2 + "</span>");
    }
    else if (r == 10){
      $(".newproject").append("<span>Commission " + articleA + " " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + adjective2 + adjectivePopup2 + " " + topic2 + topicPopup2 + ", made " + adverb + adverbPopup + "</span>");
    }
    else if (r == 11){
      $(".newproject").append("<span>Commission " + articleA + " " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + topic + topicPopup + ", generated by " + gerund + gerundPopup + "</span>");
    }
