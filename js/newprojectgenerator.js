...
function updateArtProjectGenerator(){
    ...
    var mediumPopup, topicPopup, adjectivePopup, adjectivePopup2, adverbPopup, gerundPopup;
    ...
    if (r == 0){
      ...
      $(".newproject").append("<span>Commission " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + adjective2 + adjectivePopup2 + " " + topic + topicPopup + "</span>");
    }
    else if (r == 10){
      $(".newproject").append("<span>Commission " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + adjective2 + adjectivePopup2 + " " + topic + topicPopup + ", made " + adverb + adverbPopup + "</span>");
    }
    else if (r == 11){
      $(".newproject").append("<span>Commission " + adjective + adjectivePopup + " " + medium + mediumPopup + " about " + topic + topicPopup + ", generated by " + gerund + gerundPopup + "</span>");
    }
